...
class TotalQuizApiView(APIView):
    ...
    def get_object_id(self, quiz_id):
        ...
        """
        try:
            return QuizModel.objects.get(quiz_id=quiz_id)
    ...
    def get(self, request, quiz_id=None):
        ...
        try:
            if quiz_id:
                ...
                get_all_quiz_lists = QuizModel.objects.all()
    ...
    def get(self, request, quiz_id=None):
        ...
        try:
            ...
            if quiz_id:
                ...
                print("insideelse::")
                get_all_questions_lists = QuestionModel.objects.all()
...
class OptionsApiView(APIView):
    ...
    def get_object_id(self, quiz_id):
        ...
        """
        try:
            return OptionModel.objects.filter(quiz_id=quiz_id)
    ...
    def get(self, request, quiz_id=None):
        ...
        try:
            if quiz_id:
                ...
                print("insideelse::")
                get_all_options_lists = OptionModel.objects.all()
